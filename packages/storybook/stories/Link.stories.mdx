  ...
  <Story name="appearance">
    <div>
      <div className="separate">
        <Link appearance="default" icon={ExternalLinkIcon} iconPosition="end">
          {" "}
          Default{" "}
        </Link>
        <Link appearance="primary" icon={ExternalLinkIcon} iconPosition="end">
          {" "}
          Primary{" "}
        </Link>
        <Link appearance="secondary" icon={ExternalLinkIcon} iconPosition="end">
          {" "}
          Secondary{" "}
        </Link>
        <Link appearance="danger" icon={ExternalLinkIcon} iconPosition="end">
          {" "}
          Danger{" "}
        </Link>
      </div>
