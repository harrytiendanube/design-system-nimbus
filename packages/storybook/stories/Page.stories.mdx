...
<Text>
  - Parameters <Text appearance="primary">backNavigation </Text> and{" "}
  <Text appearance="primary"> menuNavigation </Text> are mutually exclusive
</Text>
...
<Preview>
  ...
  >
    <Page
      menuNavigation={action("onClickMenuNavigation")}
      title={text("title", "Title")}
    >
