...
import { Page, Text, Menu } from "@tiendanube/components/src";
        ...
        <>
          <Page
            ...
            secondaryActions={[
              {
                children: text(
                  "secondaryActions[0].children",
                  "Organize products",
                ),
                icon: boolean("secondaryActions[0].icon", true)
                  ? DownloadIcon
                  : null,
                onClick: action("secondaryActions[0].OnClick"),
              },
              {
                ...
                icon: boolean("secondaryActions[1].icon", true)
                  ? ListIcon
                  : null,
                onClick: action("secondaryActions[1].OnClick"),
              },
