...
export const STATUS_ORDER = [
  { label: "Activas", value: "Value 1" },
  { label: "Todas", value: "Value 2" },
  { label: "Archivadas", value: "Value 3" },
  { label: "Canceladas", value: "Value 4" },
  { label: "Esperando confirmación de pago", value: "Value 5" },
  { label: "Esperando confirmación de envío", value: "Value 6" },
];

export const SHIPPING_METHOD = [
  { label: "Todos", value: "Value 1" },
