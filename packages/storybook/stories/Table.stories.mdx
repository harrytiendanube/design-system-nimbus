  ...
  <Story name="default" decorators={[withKnobs, withA11y]}>
    {() => {
      ...
      const headers = [
        ...
        { value: "Buyer" },
        { value: "Total" },
        { value: "Products", class: "nimbus--table-row__item--full-width" },
        {
          value: "Payment status",
          class: "nimbus--table-row__item--auto-width",
        },
        {
      ...
      return (
        <>
          <Table headers={headers} rows={rows} massAction={massAction} />
          <br />
    ...
    {() => {
      ...
      for (let i = 12000; i < 12005; i++) {
        rows.push([
          ...
          <Text key="4">$999.999,99</Text>,
          <Popover key="5" name={i} label="20 products" title={`Order #${i}`}>
            <ImageItem
              thumbnail="https://images.unsplash.com/photo-1525966222134-fcfa99b8ae77?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=943&q=80"
              link={LOREM_STRESS}
              linkTo="https://www.tiendanube.com/"
